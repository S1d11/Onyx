(function () {
  ...
  function renderConnections() {
    ...
    const ICONS = {
      ...
      system: `<svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.72l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.72l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.72V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.72l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.38a2 2 0 0 0-.73-2.73l-.15-.1a2 2 0 0 1-1-1.72v-.51a2 2 0 0 1 1-1.72l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.72V4a2 2 0 0 0-2-2z"/><circle cx="12" cy="12" r="3"/></svg>`,
  ...
  // ---- Launch page ----
  const LAUNCH_APPS = [
    { name: "Claude Code", desc: "Anthropic's coding tool with autogrants.", cmd: "claude", svg: `<svg viewBox="0 0 24 24" width="22" height="22" fill="currentColor"><path d="M4.709 15.955l4.72-2.647.079-.23-.079-.128-2.717-2.38c-.445-.387-.516-.873-.156-1.234.36-.36.846-.29 1.234.156l2.38 2.717.23.079.128-.079 2.647-4.72c.258-.46.744-.617 1.193-.43.45.187.617.617.359 1.077l-2.647 4.72.079.23.128.079 3.433-1.077c.516-.156.945.078 1.077.516.132.437-.156.873-.617 1.016l-3.433 1.077-.079.23.079.128 2.717 2.38c.445.387.516.873.156 1.234-.36.36-.846.29-1.234-.156l-2.38-2.717-.23-.079-.128.079-2.647 4.72c-.258.46-.744.617-1.193.43-.45-.187-.617-.617-.359-1.077l2.647-4.72-.079-.23-.128-.079-3.433 1.077c-.516.156-.945-.078-1.077-.516-.132-.437.156-.873.617-1.016l3.433-1.077.079-.23-.079-.128-2.717-2.38c-.445-.387-.516-.873-.156-1.234.36-.36.846-.29 1.234.156l2.38 2.717.23.079.128-.079 2.647-4.72c.258-.46.744-.617 1.193-.43.45.187.617.617.359 1.077z"/></svg>`, color: "#d97757" },
    { name: "Codex App", desc: "An AI agent you can delegate real work to, by OpenAI.", cmd: "codex-app", svg: `<svg viewBox="0 0 24 24" width="22" height="22" fill="currentColor"><circle cx="12" cy="12" r="10" fill="none" stroke="currentColor" stroke-width="2"/><path d="M12 6v6l4 2" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg>`, color: "#10a37f" },
    ...
    { name: "OpenClaw", desc: "Personal AI with 100+ skills.", cmd: "openclaw", svg: `<svg viewBox="0 0 24 24" width="22" height="22" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z" fill="none" stroke="currentColor" stroke-width="1.5"/></svg>`, color: "#ef4444" },
    ...
    { name: "Codex", desc: "OpenAI's open source coding agent.", cmd: "codex", svg: `<svg viewBox="0 0 24 24" width="22" height="22" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-1-13h2v6h-2zm0 8h2v2h-2z"/></svg>`, color: "#8b5cf6" },
    { name: "Copilot CLI", desc: "GitHub's AI coding agent for the terminal.", cmd: "copilot", svg: `<svg viewBox="0 0 24 24" width="22" height="22" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/></svg>`, color: "#24292e" },
    { name: "Droid", desc: "Factory's coding agent across terminal and IDEs.", cmd: "droid", svg: `<svg viewBox="0 0 24 24" width="22" height="22" fill="currentColor"><path d="M12 2a4 4 0 0 0-4 4v1H7a3 3 0 0 0-3 3v3a3 3 0 0 0 3 3h.5v2a3 3 0 0 0 3 3h3a3 3 0 0 0 3-3v-2h.5a3 3 0 0 0 3-3v-3a3 3 0 0 0-3-3h-1V6a4 4 0 0 0-4-4zm-1.5 5h3v1h-3V7z" fill="none" stroke="currentColor" stroke-width="1.5"/><circle cx="9.5" cy="12" r="1"/><circle cx="14.5" cy="12" r="1"/></svg>`, color: "#92400e" },
  ];
